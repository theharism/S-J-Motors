...
import com.mycompany.s.jmotors.FloorManager.FMControls;
import com.mycompany.s.jmotors.Staff.StaffControls;
...
public void loginpagecon(Connection con)
    {
        this.Logincon = con;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        inputUsername = jTextField1.getText();
        PreparedStatement pdt;
        String type = "";
        
        try {
            
            pdt = Logincon.prepareStatement(query);
            pdt.setString(1, inputUsername);
            pdt.setString(2,inputPassword);
        ...
        switch (type) {
            ...
            case "S" -> {
               ...
               staffControls.staffcontrolcon(Logincon);
               staffControls.setUsername(inputUsername);
               staffControls.setVisible(true);
               setVisible(false);
            }
            case "F" -> {
                 FMControls fmControls = new FMControls();
                 fmControls.getfmcontrol(Logincon);
                 fmControls.setVisible(true);
                 setVisible(false);
            }
            case "A" -> {
                Admincontrols adminControls = new Admincontrols();
                adminControls.setAdminCon(Logincon);
                adminControls.setAdminUsername(inputUsername);
